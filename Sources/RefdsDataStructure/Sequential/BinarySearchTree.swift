...
/**
 A generic binary search tree data structure implementation.
 */
public final class BinarySearchTree<T: Comparable> {
    ...
    /**
     Initializes the binary search tree with a root node.
    ...
    /**
     Inserts a node into the binary search tree recursively.
    ...
    /**
     Checks if a value exists in the binary search tree recursively.
    ...
    /**
     Traverses the binary search tree in pre-order and returns the elements.
    ...
    /**
     Traverses the binary search tree in in-order and returns the elements.
    ...
    /**
     Traverses the binary search tree in post-order and returns the elements.
    ...
    /**
     An error type that represents an invalid operation on the binary search tree.
     */
    public enum BinarySearchTreeError: Error {
        /**
         Indicates that the operation is not supported on the binary search tree.
         */
        ...
        public var description: String {
            switch self {
            case .invalidOperation:
                return "The operation is not supported on the binary search tree."
            }
        }
    }
}
