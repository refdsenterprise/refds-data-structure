...
class BinarySearchTreeTests: XCTestCase {
    ...
    func testInitWithRootValue() {
        let tree = BinarySearchTree(value: 10)
    ...
    // MARK: - BinarySearchTreeError Tests
    
    func testBinarySearchTreeErrorTitle() {
        XCTAssertEqual(BinarySearchTree<Int>.BinarySearchTreeError.invalidOperation.title, "Invalid Operation")
    }
    
    func testBinarySearchTreeErrorDescription() {
        XCTAssertEqual(BinarySearchTree<Int>.BinarySearchTreeError.invalidOperation.description, "The operation is not supported on the binary search tree.")
    }
